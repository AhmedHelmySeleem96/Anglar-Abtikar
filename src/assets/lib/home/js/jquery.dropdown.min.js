(function (e) {
    ...
    function t() {
        ...
        return e
            ? '<div class="dropdown-display-label"><div class="dropdown-chose-list">' + n + '</div></div><div class="dropdown-main">{{ul}}</div>'
            : '<a href="javascript:;" class="dropdown-display" tabindex="0"><span class="dropdown-chose-list"></span><a href="javascript:;"  class="dropdown-clear-all" tabindex="0">×</a></a><div class="dropdown-main">' + n + "{{ul}}</div>";
    }
    function i() {
        var o = this,
            n = o.config,
        ...
        clearTimeout(o.itemCountAlertTimer),
            0 === i.length && (l || (l = "最低选择" + n.minCount + "个"), (i = e('<div class="dropdown-minItem-alert">' + l + "</div>"))),
            t.append(i),
            (o.itemCountAlertTimer = setTimeout(function () {
    ...
    function l() {
        ...
        clearTimeout(o.itemLimitAlertTimer),
            0 === i.length && (l || (l = "" + n.limitCount + "个"), (i = e('<div class="dropdown-maxItem-alert">' + l + "</div>"))),
            t.append(i),
            (o.itemLimitAlertTimer = setTimeout(function () {
    ...
    function a(o) {
        var n = o || "";
        return (
            (n = n.replace(/<select[^>]*>/gi, "").replace("</select>", "")),
            (n = n.replace(/<\/optgroup>/gi, "")),
            (n = n.replace(/<optgroup[^>]*>/gi, function (e) {
    ...
    function s(o) {
        ...
        var t = o,
            i = [];
        return (
            e.each(t.children(), function (o, t) {
                var l = {},
                    a = {},
                    d = e(t);
    ...
    var c = (function () {
        ...
        u = { up: 38, down: 40, enter: 13 },
        h = { click: "click.iui-dropdown", focus: "focus.iui-dropdown", keydown: "keydown.iui-dropdown", keyup: "keyup.iui-dropdown" },
        f = 1e3,
        m = {
            show: function (o) {
                o.stopPropagation();
            ...
            control: function (o) {
                var n,
                    ...
                    d = 0;
                (l !== a.down && l !== a.up) ||
                    ((n = l === a.up ? -1 : 1), (i = this.$el.find("[tabindex]")), (t = i.index(e(document.activeElement))), (d = t === -1 ? (n + 1 ? -1 : 0) : t), (d += n), d === i.length && (d = 0), i.eq(d).focus(), o.preventDefault());
            },
            multiChoose: function (o, n) {
                ...
                (a.name = []),
                    ...
                    s.find('option[value="' + c + '"]').prop("selected", !p),
                    p && a.selectAmount < d.minCount && i.call(a),
                    a.$choseList.find(".dropdown-selected").remove(),
                    a.$choseList.prepend(a.name.join("")),
                    a.$el.find(".dropdown-display").attr("title", u.join(",")),
                    d.choice.call(a, o, t);
            },
            singleChoose: function (o) {
                ...
                return (
                    !a.hasClass("dropdown-chose") &&
                    !a.hasClass("dropdown-display") &&
                    ((n.name = []),
                    i.removeClass("active").find("li").not(a).removeClass("dropdown-chose"),
                    a.toggleClass("dropdown-chose"),
                    e.each(t.data, function (e, o) {
                    ...
                    l.find('option[value="' + d + '"]').prop("selected", !0),
                    n.name.push('<span class="placeholder">' + n.placeholder + "</span>"),
                    n.$choseList.html(n.name.join("")),
                    void t.choice.call(n, o))
                );
            },
            del: function (o) {
                var n = this,
                ...
                return (
                    ...
                    n.selectAmount--,
                    n.$el.find('[data-value="' + l + '"]').removeClass("dropdown-chose"),
                    n.$el
                        .find('[value="' + l + '"]')
                        .prop("selected", !1)
                        .removeAttr("selected"),
                    i.closest(".dropdown-selected").remove(),
                    t.choice.call(n, o),
                    !1
                );
            },
    ...
    (r.prototype = {
        ...
        renderSelect: function (o, n) {
            ...
            o ? d.find("ul")[n ? "html" : "append"](r) : ((i = t.call(l).replace("{{ul}}", "<ul>" + r + "</ul>")), d.append(i).find("ul").removeAttr("style class")),
                n && ((l.name = []), l.$el.find(".dropdown-selected").remove(), l.$select.val("")),
                (l.$choseList = d.find(".dropdown-chose-list")),
                l.isLabelMode || l.$choseList.html(e('<span class="placeholder"></span>').text(l.placeholder)),
                l.$choseList.prepend(l.name ? l.name.join("") : []);
        },
        bindEvent: function () {
            var o = this,
                n = o.$el,
            ...
            n.on(h.click, function (e) {
                ...
                n.on(h.click, ".del", e.proxy(m.del, o)),
                o.isLabelMode
                    ? (n.on(h.click, ".dropdown-display-label", function () {
                          n.find("input").focus();
                      }),
                      o.config.searchable ? n.on(h.focus, "input", e.proxy(m.show, o)) : n.on(h.click, e.proxy(m.show, o)),
                      n.on(h.keydown, "input", function (e) {
                          8 === e.keyCode && "" === this.value && o.name.length && n.find(".del").eq(-1).trigger("click");
                      }))
                    : (n.on(t, ".dropdown-display", e.proxy(m.show, o)), n.on(t, ".dropdown-clear-all", e.proxy(m.clearAll, o))),
                n.on(h.keyup, "input", e.proxy(m.search, o)),
                n.on(h.keyup, function (n) {
                    var t = n.keyCode,
                        i = u;
                    t === i.enter && e.proxy(o.isSingleSelect ? m.singleChoose : m.multiChoose, o, n)();
                }),
                n.on(h.keydown, e.proxy(m.control, o)),
                n.on(h.click, "li[tabindex]", e.proxy(o.isSingleSelect ? m.singleChoose : m.multiChoose, o));
        },
        unbindEvent: function () {
            ...
            o.off(h.click),
                o.off(h.click, ".del"),
                e.isLabelMode ? (o.off(h.click, ".dropdown-display-label"), o.off(h.focus, "input"), o.off(h.keydown, "input")) : (o.off(n, ".dropdown-display"), o.off(n, ".dropdown-clear-all")),
                o.off(h.keyup, "input"),
                o.off(h.keyup),
                o.off(h.keydown),
                o.off(h.click, "[tabindex]");
        },
