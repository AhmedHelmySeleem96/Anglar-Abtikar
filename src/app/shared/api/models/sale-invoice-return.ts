...
import { SaleInvoiceReturnDetails } from './sale-invoice-return-details';
export interface SaleInvoiceReturn {
  bankGuid?: string;
  bankId?: number;
  ...
  saleInvoiceReturnDetails?: null | Array<SaleInvoiceReturnDetails>;
  shiftId?: number;
  storeGuid?: string;
  storeId?: number;
