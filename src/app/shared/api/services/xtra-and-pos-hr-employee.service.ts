...
export class XtraAndPosHrEmployeeService extends BaseService {
  ...
  /** Path part for operation `httpPostXtraAndPosHrEmployeeImportExcel()` */
  static readonly HttpPostXtraAndPosHrEmployeeImportExcelPath = '/XtraAndPOS_HREmployee/ImportExcel';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `httpPostXtraAndPosHrEmployeeImportExcel()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  httpPostXtraAndPosHrEmployeeImportExcel$Response(
    params?: {
      body?: {
'file'?: Blob;
}
    ...
    const rb = new RequestBuilder(this.rootUrl, XtraAndPosHrEmployeeService.HttpPostXtraAndPosHrEmployeeImportExcelPath, 'post');
    if (params) {
  ...
  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `httpPostXtraAndPosHrEmployeeImportExcel$Response()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  httpPostXtraAndPosHrEmployeeImportExcel(
    params?: {
      body?: {
'file'?: Blob;
}
    ...
    return this.httpPostXtraAndPosHrEmployeeImportExcel$Response(params, context).pipe(
      map((r: StrictHttpResponse<void>): void => r.body)
    );
  }
