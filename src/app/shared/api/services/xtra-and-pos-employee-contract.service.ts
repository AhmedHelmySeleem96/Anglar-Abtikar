...
export class XtraAndPosEmployeeContractService extends BaseService {
  ...
  /** Path part for operation `httpPostXtraAndPosEmployeeContractImportExcel()` */
  static readonly HttpPostXtraAndPosEmployeeContractImportExcelPath = '/XtraAndPOS_EmployeeContract/ImportExcel';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `httpPostXtraAndPosEmployeeContractImportExcel()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  httpPostXtraAndPosEmployeeContractImportExcel$Response(
    params?: {
      body?: {
'file'?: Blob;
}
    ...
    const rb = new RequestBuilder(this.rootUrl, XtraAndPosEmployeeContractService.HttpPostXtraAndPosEmployeeContractImportExcelPath, 'post');
    if (params) {
  ...
  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `httpPostXtraAndPosEmployeeContractImportExcel$Response()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  httpPostXtraAndPosEmployeeContractImportExcel(
    params?: {
      body?: {
'file'?: Blob;
}
    ...
    return this.httpPostXtraAndPosEmployeeContractImportExcel$Response(params, context).pipe(
      map((r: StrictHttpResponse<void>): void => r.body)
    );
  }
