...
import {XtraAndPosJobCategoryService, XtraAndPosLookUpsService } from 'src/app/shared/api';


@Component({
  selector: 'app-jobs-categories',
  templateUrl: './jobs-categories.component.html',
  styleUrls: ['./jobs-categories.component.css'],
  providers: [ExportData]
})
export class JobsCategoriesComponent implements OnInit {
  constructor(
    private toastr:ToastrService,
    private router: Router,private ExportData :ExportData,  private XtraAndPosLookUpsService :XtraAndPosLookUpsService
    ,  private XtraAndPosJobCategoryService :XtraAndPosJobCategoryService,
    ...
    formJob : FormGroup;
      ...
      deleteJob(job: any) {
        this.XtraAndPosJobCategoryService.httpDeleteXtraAndPosJobCategoryDeleteJobCategoryService({
          id: job.Id,
        }).subscribe((value: any) => {
          let jsonData = JSON.parse(value);
          this.toastr.clear();
      ...
      OnSubmit(Form: FormGroup) {
        ...
        model.statusId= 1  ;
        this.XtraAndPosJobCategoryService.httpPostXtraAndPosJobCategoryCreateJobCategoryService({
          body : model
        }).subscribe((value:any)=>{
          let jsonData = JSON.parse(value);
            this.toastr.success(jsonData.Message)
        ...
        this.XtraAndPosJobCategoryService.httpPutXtraAndPosJobCategoryUpdateJobCategoryService({
      ...
      refreshTable() {
        this.XtraAndPosJobCategoryService.httpGetXtraAndPosJobCategoryGetJobCategoryService().subscribe((value: any) => {
          ...
          this.JobData = jsonJobData.Obj.jobCat;
        });
      }
      getJob(id :any){
